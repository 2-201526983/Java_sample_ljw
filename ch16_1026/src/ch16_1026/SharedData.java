...
public class SharedData {
   ...
   public synchronized void up (String name){ // synchronized 뺴면 수행을 보장 해주지 않음
      ...
      data++;
      System.out.println( "를 "+ data +" 로 증가시킴_ UP 메서드 수행을 보장 받았음");
   }
   public synchronized void down (String name){
      ...
      System.out.print( name +" 이"+ data );
      data--;
      System.out.println( "를 "+ data +" 로 감소시킴_ Down메서드 수행을 보장 받았음");
   }
}