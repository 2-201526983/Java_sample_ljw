...
public class RestaurantDB {
    ...
    public List<RestaurantDto> makeList(){
        ...
        restaurantDtos.add(new RestaurantDto("시더스초밥", "JAPANESE", "초밥", "051-805-7774",
                "부산 부산진구 부전동 19-1", "초밥, 모듬튀김", "부산광역시 부산진구 서면문화로 7 1층", "https://place.map.kakao.com/2060454105",
        ...
        restaurantDtos.add(new RestaurantDto("나노갈매기 서면1호점", "KOREAN", "육류,고기", "051-808-0029",
                "부산 부산진구 부전동 13-5", "삼겹살, 목살, 가브리살", "부산광역시 부산진구 서전로10번길 32", "https://place.map.kakao.com/13129076",
        ...
        restaurantDtos.add(new RestaurantDto("부산댁", "KOREAN", "육류,고기", "051-808-0661",
                "부산 부산진구 부전동 180", "모듬한판, 항정살", "부산광역시 부산진구 동천로107번길 14", "https://place.map.kakao.com/1705068258",
        ...
        restaurantDtos.add(new RestaurantDto("롤링파스타", "WESTERN", "이탈리안", "051-804-8046",
                "부산 부산진구 부전동 5-5", "크림 수프 파스타, 매운 크림 파스타", "부산광역시 부산진구 서전로10번길 60", "https://place.map.kakao.com/1727802721",
        ...
        restaurantDtos.add(new RestaurantDto("카츠와라", "JAPANESE", "돈까스", "051-804-5799",
                "부산 부산진구 부전동 7-15", "돈까스, 옛날 돈까스", "부산 부산진구 서면로68번길 42 1층", "https://place.map.kakao.com/68296224",
        ...
        restaurantDtos.add(new RestaurantDto("옹헤야불백", "KOREAN", "육류,고기", "070-4175-0075",
                "부산 부산진구 부전동 11-11", "불백, 고추장 불백", "부산 부산진구 서전로 14 1층", "https://place.map.kakao.com/30255959",
        ...
        restaurantDtos.add(new RestaurantDto("맛있는삼시세끼", "KOREAN", "육류,고기", "0507-1389-8384",
                "부산 부산진구 부전동 43-13", "고기정식, 두루치기", "부산 부산진구 중앙대로692번길 45-6 1층", "https://place.map.kakao.com/121680096",
        ...
        restaurantDtos.add(new RestaurantDto("동해물회", "KOREAN", "물회", "051-737-5115",
                "부산 부산진구 부전동 263", "물회", "부산 부산진구 서전로 13 2층", "https://place.map.kakao.com/9772721",
        ...
        restaurantDtos.add(new RestaurantDto("종로불돼지", "KOREAN", "쌈밥정식", "051-734-1190",
                "부산 부산진구 부전동 155", "쌈정식", "부산 부산진구 중앙대로 711 지하1층", "https://place.map.kakao.com/8655423",
        ...
        restaurantDtos.add(new RestaurantDto("도우개러지", "WESTERN", "이탈리안", "051-739-8208",
                "부산 부산진구 부전동 19-11", "스파게티, 화덕피자", "부산 부산진구 서전로46번길 8 1층", "https://place.map.kakao.com/808624923",
        ...
        restaurantDtos.add(new RestaurantDto("라마앤바바나", "ASIAN", "인도음식", "051-318-0094",
                "부산 부산진구 부전동 35-2", "커리, 나시고랭, 탄두리", "부산 부산진구 중앙대로680번길 45-8 1층", "https://place.map.kakao.com/18773207",
        ...
        restaurantDtos.add(new RestaurantDto("아임타이", "ASIAN", "태국음식", "051-725-1688",
                "부산 부산진구 부전동 43-7", "팟타이", "부산 부산진구 전포대로199번길 12 1층", "https://place.map.kakao.com/1450575364",
        ...
        restaurantDtos.add(new RestaurantDto("짚신매운갈비찜", "KOREAN", "육류고기", "051-725-9233",
                "부산 부산진구 부전동 11-13", "돼지갈비찜, 소갈비찜", "부산 부산진구 서전로10번길 34 1층", "https://place.map.kakao.com/17606304",
        ...
        restaurantDtos.add(new RestaurantDto("철인7호", "KOREAN", "치킨", "051-722-9992",
                "부산 부산진구 부전동 44-1", "후라이드, 순살콤보", "부산 부산진구 서전로10번길 31-3 1층", "https://place.map.kakao.com/23350363",
        ...
        restaurantDtos.add(new RestaurantDto("일편등심", "KOREAN", "육류고기", "051-4104-9922",
                "부산 부산진구 부전동 180", "한우 눈꽃 등심, 안심", "부산 부산진구 서전로10번길 50 1층", "http://place.map.kakao.com/916261841",
        ...
        restaurantDtos.add(new RestaurantDto("종로양꼬치", "CHINESE", "양꼬치", "051-720-8168",
                "부산 부산진구 부전동 13-7", "양모듬, 고급양갈비", "부산 부산진구 서전로10번길 50 1층", "http://place.map.kakao.com/15864091",
        ...
        restaurantDtos.add(new RestaurantDto("당산오돌", "KOREAN", "육류고기", "051-723-3590",
                "부산 부산진구 부전동 44-5", "꼬들살, 눈꽃갈비", "부산 부산진구 서전로10번길 50 1층", "http://place.map.kakao.com/3678525",
        ...
        restaurantDtos.add(new RestaurantDto("오로지라멘", "JAPANESE", "일본식라면", "051-733-9279",
                "부산 부산진구 부전동 13-2", "돈코츠라멘, 오로지라멘", "부산 부산진구 서전로10번길 50 1층", "http://place.map.kakao.com/1414375847",
        ...
        restaurantDtos.add(new RestaurantDto("왕비집", "KOREAN", "육류고기", "051-720-3066",
                "부산 부산진구 부전동 12-11", "소갈비정식, 한우불고기정식", "부산 부산진구 서전로10번길 50 1층", "http://place.map.kakao.com/15232887",
        ...
        restaurantDtos.add(new RestaurantDto("고메식당", "KOREAN", "육류고기", "051-723-0999",
                "부산 부산진구 부전동 43-5", "이베리코 돼지 꽃목살, 명품 숙성 삼겹살", "부산 부산진구 서전로10번길 50 1층", "http://place.map.kakao.com/2131396403",
        ...
        restaurantDtos.add(new RestaurantDto("소소횟집", "KOREAN", "해물생선회", "051-733-1226",
                "부산 부산진구 부전동 11-1", "물회, 모듬회", "부산 부산진구 서전로10번길 50 1층", "https://place.map.kakao.com/14707328",
        ...
        restaurantDtos.add(new RestaurantDto("유해업소 서면점", "KOREAN", "육류,고기", "051-722-3852",
                "부산 부산진구 부전동 6-4", "숯불닭갈비, 양념닭갈비", "부산 부산진구 서전로10번길 50 1층", "http://place.map.kakao.com/1750296031",
        ...
        restaurantDtos.add(new RestaurantDto("어쭈 서면점", "KOREAN", "해물생선", "051-732-8806",
                "부산 부산진구 부전동 175", "쭈꾸미 볶음, 물총칼국수", "부산 부산진구 서면로 26 1층", "https://place.map.kakao.com/19926048",
