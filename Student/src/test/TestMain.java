...
public class TestMain {
	...
	public static void main(String[] args) throws FileNotFoundException {
		...
		test.creatSubject();
		// 학생 추가, 2개의 메서드 들은 같은 클래스 내부에 있으니 , 확인
	//	test.createStudent();
	...
	public void creatSubject(){
		...
		// 방송과목 추가 및 상적 평가는 70 이상이면 Pass 평가 방식 채택
	...
	public void createStudent(){
		// 학생 추가 요구시 아래에 추가하기. 본인이름으로 , 학번은 221102 , 자기이름, 컴퓨터(과목 추가 예정), 지금은 방송댄스로 임시 추가.
		...
		Student student6 = new Student(221102, "이재원", dance );
		...
		// 추가한 학생이 수강한 과목은 지정 해줄예정, 임시로 ,수학 ,방송 댄스만 추가
